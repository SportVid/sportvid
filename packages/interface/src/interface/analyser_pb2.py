...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_PLUGINDATATYPE']._serialized_end=2918
  ...
  _globals['_ANALYSER']._serialized_start=2921
  _globals['_ANALYSER']._serialized_end=3770
