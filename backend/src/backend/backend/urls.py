...
urlpatterns = [
    ...
    path("video/list",
        views.VideoList.as_view(), name="video_list"),
    path("video/get",
        views.VideoGet.as_view(), name="video_get"),
    path("video/rename",
        views.VideoRename.as_view(), name="video_rename"),
    path("video/delete",
        views.VideoDelete.as_view(), name="video_delete"),
    path("video/export",
        views.VideoExport.as_view(), name="video_export"),
    # ---------- TRACKING DATA
    path("tracking_data/upload",
        views.TrackingDataUpload.as_view(), name="tracking_data_upload"),
    path("tracking_data/list",
        views.TrackingDataList.as_view(), name="tracking_data_list"),
    path("tracking_data/get",
        views.TrackingDataGet.as_view(), name="tracking_data_get"),
    path("tracking_data/rename",
    ...
    path("plugin/run/new",
        views.PluginRunNew.as_view(), name="plugin_run_new"),
    path("plugin/run/list",
        views.PluginRunList.as_view(), name="plugin_run_list"),
    path("plugin/run/delete",
    ...
    # ---------- TIMELINE
    path("timeline/list", 
        views.TimelineList.as_view(), name="timeline_list"),
    path("timeline/list_all", 
        views.TimelineListAll.as_view(), name="timeline_list_all"),
    path("timeline/duplicate",
        views.TimelineDuplicate.as_view(), name="timeline_duplicate"),
    path("timeline/rename", 
        views.TimelineRename.as_view(), name="timeline_rename"),
    path("timeline/setparent",
        views.TimelineSetParent.as_view(), name="timeline_setparent"),
    path("timeline/setcollapse",
        views.TimelineSetCollapse.as_view(), name="timeline_setcollapse"),
    path("timeline/setorder",
        views.TimelineSetOrder.as_view(), name="timeline_setorder"),
    path("timeline/changevisualization",
        views.TimelineChangeVisualization.as_view(),
        name="timeline_change_visualization"),
    path("timeline/import/eaf",
        views.TimelineImportEAF.as_view(), name="timeline_import_eaf"),
    path("timeline/delete", 
        views.TimelineDelete.as_view(), name="timeline_delete"),
    path("timeline/create", 
        views.TimelineCreate.as_view(), name="timeline_create"),
    # ---------- TIMELINE/SEGMENT
    path("timeline/segment/get",
        views.TimelineSegmentGet.as_view(),
        name="timeline_segment_get"),
    path("timeline/segment/list",
        views.TimelineSegmentList.as_view(),
        name="timeline_segment_list"),
    path("timeline/segment/merge",
        views.TimelineSegmentMerge.as_view(),
        name="timeline_segment_list"),
    path("timeline/segment/split",
        views.TimelineSegmentSplit.as_view(),
        name="timeline_segment_list"),
    path("timeline/segment/annotate",
        views.TimelineSegmentAnnotate.as_view(),
        name="timeline_segment_annotate"),
    path("timeline/segment/annotate/range",
        views.TimelineSegmentAnnotateRange.as_view(),
        name="timeline_segment_annotate_range"),
    path("timeline/segment/annotation/list",
        views.TimelineSegmentAnnoatationList.as_view(),
        name="timeline_segment_annotation_list"),
    path("timeline/segment/annotation/create",
        views.TimelineSegmentAnnoatationCreate.as_view(),
        name="timeline_segment_annotation_create"),
    path("timeline/segment/annotation/toggle",
        views.TimelineSegmentAnnoatationToggle.as_view(),
        name="timeline_segment_annotation_toggle"),
    path("timeline/segment/annotation/delete",
        views.TimelineSegmentAnnoatationDelete.as_view(),
        name="timeline_segment_annotation_delete"),
    # ---------- ANNOTATION
    path("annotation/list",
        views.AnnoatationList.as_view(), name="annotation_list"),
    path("annotation/create",
        views.AnnoatationCreate.as_view(), name="annotation_create"),
    path("annotation/update",
         views.AnnoatationChange.as_view(), name="annotation_change"),
    path("annotation/delete",
         views.AnnoatationChange.as_view(), name="annotation_change"),
    # ---------- ANNOTATION/CATEGORY
    path("annotation/category/list",
        views.AnnoatationCategoryList.as_view(),
        name="annotation_category_list"),
    path("annotation/category/create",
        views.AnnoatationCategoryCreate.as_view(),
        name="annotation_category_create"),
    path("annotation/category/update",
        views.AnnoatationCategoryCreate.as_view(),
        name="annotation_category_create"),
    path("annotation/category/delete",
        views.AnnoatationCategoryCreate.as_view(),
        name="annotation_category_create"),
    # ---------- SHORTCUT
