...
export const useClusterTimelineItemStore = defineStore("clusterTimelineItem", () => {
    const clusterTimelineItems = reactive({});
    ...
    const setSelectedPlaceClustering = async ({ videoId = null, pluginRunId = null }) => {
        ...
        try {
            await axios.post(
                `${config.API_LOCATION}/video/analysis/setselectedplaceclustering`,
                params
            );
        } finally {
    ...
    const setSelectedFaceClustering = async ({ videoId = null, pluginRunId = null }) => {
        ...
        try {
            await axios.post(
                `${config.API_LOCATION}/video/analysis/setselectedfaceclustering`,
                params
            );
        } finally {
            isLoading.value = false;
