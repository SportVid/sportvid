<template>
  ...
  <v-container v-else class="d-flex flex-column">
    <v-row class="mt-1" justify="center">
      <div style="position: relative; display: inline-block">
        ...
        <template v-for="position in topViewStore.positionDataTopView[currentTime]" :key="position">
          ...
          >
            <svg v-if="topViewStore.currentSport.title === $t('sports.soccer')" viewBox="0 0 64 64">
            ...
            <svg
              v-else-if="topViewStore.currentSport.title === $t('sports.handball')"
              viewBox="0 0 512 512"
            >
    ...
    M373.331,426.669h10.676c-6.767,5.083-13.846,9.771-21.203,14.035L373.331,426.669z"
            ...
            <svg
              v-else-if="topViewStore.currentSport.title === $t('sports.basketball')"
              id="Layer_1"
