<template>
  <v-footer class="d-flex flex-column" color="primary" style="height: 90px; max-height: 90px">
    <v-col class="py-2">
      <div class="link-row">
        <div class="link-wrapper">
          <router-link to="/guidelines" class="router-link">
            {{ $t("guidelines.title") }}
          </router-link>
        </div>
        ...
        <div class="link-wrapper">
          <router-link to="/legal-notice" class="router-link">
