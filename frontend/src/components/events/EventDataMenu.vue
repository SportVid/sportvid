<template>
  <div style="min-height: 60vh; position: relative" data-tour="event-data-menu">
    ...
    <v-col style="position: relative">
          ...
          <v-col cols="10">
            <v-sheet border rounded class="pa-4 bg-transparent">
              ...
              <v-row style="justify-content: center; align-items: center" class="mt-4 mb-n2">
                ...
                <v-col cols="auto" class="text-grey px-2">{{ $t("event_data.generate.or") }}</v-col>
                <v-col cols="4" class="d-flex align-center">
                  <v-divider />
                </v-col>
              </v-row>
      ...
      <v-row style="justify-content: center" class="mt-10 mb-6">
        ...
        <ModalEventDataSelect v-if="showModalEventDataSelect" v-model="showModalEventDataSelect" />
      </v-row>
