...
export class TimeBar extends PIXI.Container {
  ...
  renderBar() {
    ...
    bar.fill(0xae1313);
    bar.moveTo(0, handleHeight);
    bar.lineTo(handleWidth, 0);
    bar.lineTo(-handleWidth, 0);
    bar.lineTo(0, handleHeight);
    bar.closePath();
    bar.fill();
  ...
  selectRange(start, end) {
    ...
    selectionRect.roundRect(0, 25, width, height - 25, 1);
    selectionRect.x = x;
    selectionRect.fill(this.pRangeSelectedColor, 0.4);
