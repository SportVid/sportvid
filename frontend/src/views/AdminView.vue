...
const headers = [
  ...
  { title: t("admin_panel.user.used_storage_size"), value: "used_storage_size", sortable: true },
  { title: t("admin_panel.user.max_storage_size"), value: "max_storage_size", sortable: true },
